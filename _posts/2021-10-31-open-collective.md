...
Payment happens when any pull requests/blog posts/tutorials are being approved. That means that even if a goal for a project is reached, a payment only happens when pull requests/blog posts/tutorials are being approved by other contributors.

People can also choose to donate to a specific project rather than the Stride collective in general if they want to. So if you only want to see your money being used for a specific cause, you are completely free to do so. You are more than welcome to do both of course. In the image below you can see an example of how money that has been donated to the Stride collective, has been partially alloced to a specific project.

![Allocating budget](/images/blog/2021-10-31-open-collective/allocate_budget.JPG)

## What's next? ##
We first want to see how this first month of the new platform goes. At the end of November/beginning December we will hold a new community meeting and we will discuss how things went and what we plan to do with the donations.
...
* Write some more info on the entire process on how contributors spend money
