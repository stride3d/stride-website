...
{% video '/images/blog/release-1.9/game_templates.mp4' %}
...
{% video '/images/blog/copy_paste/Copy_InsertIntoList.mp4' %}

* Copy and insert into the list (by pasting at a list item level).*

{% video '/images/blog/copy_paste/Copy_AppendToList.mp4' %}

* Copy and append to a list, for example, append it to the end of the list.

{% video '/images/blog/copy_paste/Copy_ReplaceList.mp4' %}
...
{% video '/images/blog/copy_paste/Copy_ReplaceIntoList.mp4' %}
...
{% video '/images/blog/copy_paste/CopyPaste_PropertyGrid.mp4' %}
